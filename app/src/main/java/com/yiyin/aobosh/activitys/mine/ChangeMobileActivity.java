...
public class ChangeMobileActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        new_mobile_et = (EditText) findViewById(R.id.new_mobile_et);
        captcha_et = (EditText) findViewById(R.id.captcha_et);
        old_mobile_et = (TextView) findViewById(R.id.old_mobile_et);
        get_captcha = (TextView) findViewById(R.id.get_captcha);
        change_mobile_commit = (TextView) findViewById(R.id.change_mobile_commit);
