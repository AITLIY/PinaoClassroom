...
//        videoPlayer.restart();
    ...
    private void initData() {
        ...
        getLessonSonList(mUserInfo.getUid(), lessonID, Suffix_type, page);
...
//        videoPlayer.setSpeed(1.0f);
    ...
    public void joinQQ() {
        try {
            ...
            String url = "mqqwpa://im/chat?chat_type=wpa&uin=" + "2423834238";//uin是发送过去的qq号码
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(url)));
        } catch (Exception e) {
            e.printStackTrace();
            ToastUtil.show(mContext, "请检查是否安装QQ");
        }
    }
...
//                    getLessonsonEvaluate(mUserInfo.getUid(), lessonID, page2);
    ...
    private void initPullListView() {
        ...
        lesson_item_list.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {  //拉动时
            ...
            public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
                ...
                getLessonSonList(mUserInfo.getUid(), lessonID, Suffix_type, page); // 下拉刷新搜索
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                ...
                getLessonSonList(mUserInfo.getUid(), lessonID, Suffix_type, page);  // 上拉加载搜索
    ...
    private void typeForSort(String type) {
        ...
        Suffix_type = type;
        mSearchType = SEARCH_LESSON_PARAMETER;
        getLessonSonList(mUserInfo.getUid(), lessonID, Suffix_type, page); //根据类型
    }
...
//                        mHandler.sendEmptyMessage(LOAD_DATA_FAILE);
    ...
    // 获取视频列表数据
    private void getLessonSonList(final int uid, final int lessonid, final String suffix, final int pindex) {
