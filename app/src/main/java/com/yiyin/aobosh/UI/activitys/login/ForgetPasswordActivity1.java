...
public class ForgetPasswordActivity1 extends Activity implements View.OnClickListener {
    ...
    private EditText moible_ed,captcha_ed;
    private Button forget_get_captcha;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case LOAD_DATA_SUCCESS2:
                    ...
                    Intent intent = new Intent(mContext, ForgetPasswordActivity2.class);
    ...
    private Runnable myTask = new Runnable() {
        ...
        @Override
        public void run() {
            forget_get_captcha.setText("重新发送("+num1+")");        // 提示剩余时间
            forget_get_captcha.setEnabled(false);                    //禁止再次点击发送验证码

            num1--;                                                    //默认最大为60每隔一秒发送一个
            if (num1 >= 0) {
                mHandler.postDelayed(this, 1000);
            } else {
                forget_get_captcha.setText(R.string.get_captcha);
                forget_get_captcha.setEnabled(true);
    ...
    private void initView() {
        ...
        moible_ed = findViewById(R.id.moible_ed);
        captcha_ed = findViewById(R.id.captcha_ed);
        forget_get_captcha = findViewById(R.id.forget_get_captcha);
        forget_password_next = findViewById(R.id.forget_password_next);
