...
public class OauthHistoryActivity extends Activity {
                ...
                case LOAD_DATA1_SUCCESS:
                    ...
                    if (mSearchType==SEARCH_LESSON_PARAMETER) {
                        ...
                        if (mLessonSearches.size()>0){
                            ...
                            setViewForResult(false,"您还没有浏览任何课程信息~");
                        }
                    }
                    break;
    ...
    private void initPullListView() {
        ...
        lesson_item_list.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {  //拉动时
            ...
            public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
                ...
                getHistory(mUserInfo.getUid(),page); // 下拉刷新搜索
                setViewForResult(true,"");
                LogUtils.i("OauthHistoryActivity: onPullDownToRefresh 下拉" + page + "页");
            }
    ...
    private void upDataLessonListView() {
        ...
        switch (mSearchType) {
            ...
            case SEARCH_LESSON_PARAMETER:
                ...
                LogUtils.i("OauthHistoryActivity: SEARCH_LESSON_FOR_PARAMETER "  + mShowList.size());
            ...
            case SEARCH_LESSON_PULL_UP:
                ...
                LogUtils.i("OauthHistoryActivity: SEARCH_LESSON_PULL_UP " + mShowList.size());
    ...
    // 获取足迹
    private void getHistory(final int uid, final int pindex) {

        String url = HttpURL.OAUTH_HISTORY_URL;
        StringRequest stringRequest = new StringRequest(Request.Method.POST,url,new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                if (!"".equals(s)) {
                    LogUtils.i("OauthHistoryActivity: result1 " + s);
                    ...
                    try {
                        ...
                        if ("200".equals(code)) {
                            ...
                            LogUtils.i("OauthHistoryActivity: mLessonSearches.size " + mLessonSearches.size());
            ...
            public void onErrorResponse(VolleyError volleyError) {
                LogUtils.e("OauthHistoryActivity: volleyError1 " + volleyError.toString());
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                try {
                    ...
                    String token = "Oauthhistory" + TimeUtils.getCurrentTime("yyyy-MM-dd") + CommonParameters.SECRET_KEY;
                    LogUtils.i("OauthHistoryActivity: token " + token);
                ...
                LogUtils.i("OauthHistoryActivity json1 " + obj.toString());
