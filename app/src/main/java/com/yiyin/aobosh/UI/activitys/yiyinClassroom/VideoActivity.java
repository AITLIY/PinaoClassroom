...
public class VideoActivity extends Activity implements SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    private void initData() {
        ...
        if (intent != null) {
            ...
            LogUtils.i("VideoActivity: lessonBean id " + lessonBean.getId());
...
//            Uri uri = Uri.parse(mListBeans.get(0).getVideourl());
            Uri uri = Uri.parse("http://yykt.aobosh.cn/%E9%B2%81%E6%96%AF%E5%85%B0%E9%92%A2%E7%90%B4%E8%80%83%E7%BA%A7%E7%AC%AC%E5%8D%81%E7%BA%A7/1.%E5%85%AB%E5%BA%A6%E7%BB%83%E4%B9%A0%E6%9B%B2.mp4");
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    if (mMediaPlayer != null) {
                                        ...
                                        LogUtils.i("VideoActivity: getVideotime " + mListBeans.get(0).getVideotime()
    ...
    private void getLessonsonFindson(final int uid, final int lessonid, final String suffix, final int pindex) {
        ...
        StringRequest stringRequest = new StringRequest(com.android.volley.Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                if (!"".equals(s)) {
                    LogUtils.i("VideoActivity: result1 " + s);
            ...
            public void onErrorResponse(VolleyError volleyError) {
                LogUtils.e("VideoActivity: volleyError1 " + volleyError.toString());
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                try {
                    ...
                    LogUtils.i("VideoActivity: token " + token);
                ...
                LogUtils.i("VideoActivity json1 " + obj.toString());
